package com.excilys.servlet.mapper;
...
public class RequestParamExtractor {
	private int  LIMIT_DEFAULT = 20;
	private static final boolean ALPHA_NUMERICAL_ORDER_DEFAULT = true;
	...
	public ComputerDTO getComputerDTO() {
		...
		return new ComputerDTO((computerName == null) ? computerName : computerName.trim(),
	...
	public Boolean getOrderAlphaNumerical() {
		...
		if (orderAlphaNumericalStr != null && (orderAlphaNumericalStr.equalsIgnoreCase("true")
				|| orderAlphaNumericalStr.equalsIgnoreCase("false"))) {
